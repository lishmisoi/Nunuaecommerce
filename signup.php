           ...
           <?php include ('nav_sidebar.php');?>
            <div id="content">
                ...
                <div id="body">
                    ...
                    <h3>Nunua Electronics</h3>
                    <div class="signup">
                        <a href="order.php" class="btn btn-primary"><i class="icon-signin"></i>&nbsp;Login</a>
                    </div>
                    <hr>
                                        ...
                                        if ($firstname != "" && $password == $rpassword && $lastname != "" && $eaddress != "" && $cn != "" && $address != "" && preg_match($pattern,$eaddress) ) {
                                         ...
                                         ('$firstname','$lastname','$eaddress','$password','$cn','$address')") or die(mysqli_error());
                                            ...
                                            <script type="text/javascript">
                                                alert("You are Succesfully Registered Please Login Your Account");
...
<?php } ?>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="inputEmail">Postal Address</label>
                                            <div class="controls">
...
<?php } ?>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="cn" id="inputEmail" placeholder="Phone Number">
<?php if (isset($_POST['save'])) { ?>
...
<?php } ?>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                ...
                                                <button type="submit" name="save" class="btn btn-primary"><i class="icon-pencil"></i>&nbsp;Sign Up</button>
                                            </div>
                                        </div>
                                    </form>
