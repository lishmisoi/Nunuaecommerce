                ...
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <div class="hero-unit-table">
							...
							<a href = "" name = "" class = "btn btn-success">Laptops</a> 
							<a href = "" name = "" class = "btn btn-primary">Phones and Tablets</a> 
							<a href = "" name = "" class = "btn btn-info">Tvs</a> 
							<a href = "" name = "" class = "btn btn-danger">Printers</a> 
							<a href = "" name = "" class = "btn btn-primary">Servers</a>
