            ...
            <div id="content">
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <ul class="thumbnails">
                            <?php
                            $query = mysqli_query($conn, "select * from tb_products WHERE category = 'laptops'") or die(mysqli_error());
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        ...
                                        <p>
                                            <a> Price:Ksh <?php echo $row['price']; ?></a>
                                        </p>
                                     										<?php if($total_qty > 0){ ?>
                                    ...
                                    if (isset($_POST['order'])) {
                                     ...
                                     /*    header('location:user_wines.php'); */
										?>
												<script>
																window.location = 'user_laptops.php';				
																</script>
										<?php
                                    }
                                    ?>
